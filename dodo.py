"""
Doit build file for Treasury-Swap Basis pipeline.
"""
...
def task_pull():
    """Pull Treasury yields and swap rates from Bloomberg."""
    return {
        "actions": ["python src/pull_bbg_treasury_swap.py"],
        "file_dep": ["src/pull_bbg_treasury_swap.py"],
        "targets": [
            DATA_DIR / "treasury_yields.parquet",
            DATA_DIR / "swap_rates.parquet",
        ],
        "verbosity": 2,
        "task_dep": ["config"],
    }
...
def task_calc():
    """Calculate Treasury-Swap basis."""
    return {
        "actions": ["python src/calc_treasury_swap_basis.py"],
        "file_dep": [
            "src/calc_treasury_swap_basis.py",
            DATA_DIR / "treasury_yields.parquet",
            DATA_DIR / "swap_rates.parquet",
        ],
        "targets": [DATA_DIR / "treasury_swap_basis.parquet"],
        "verbosity": 2,
        "task_dep": ["pull"],
    }
...
def task_format():
    ...
    return {
        ...
        "file_dep": [
            ...
            DATA_DIR / "treasury_swap_basis.parquet",
        ],
        "targets": [DATA_DIR / "ftsfr_treasury_swap_basis.parquet"],
        "verbosity": 2,
        "task_dep": ["calc"],
    }
...
def task_run_notebooks():
    ...
    notebook_ipynb = NOTEBOOK_BUILD_DIR / "summary_treasury_swap_basis.ipynb"
    ...
    return {
        ...
        "targets": [
            notebook_ipynb,
            OUTPUT_DIR / "summary_treasury_swap_basis.html",
        ],
        "verbosity": 2,
        "task_dep": ["format"],
    }
...
def task_generate_pipeline_site():
    ...
    return {
        ...
        "file_dep": [
            "chartbook.toml",
            NOTEBOOK_BUILD_DIR / "summary_treasury_swap_basis.ipynb",
        ],
